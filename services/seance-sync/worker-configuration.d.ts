/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./worker-configuration.d.ts` (hash: eb126de304eb0fabae471249e8a141ef)
// Runtime types generated with workerd@1.20260405.1 2026-04-08 nodejs_compat_v2
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "VaultAuthority" | "RoomAuthority";
	}
	interface Env {
		SYNC_BLOBS: R2Bucket;
		DB: D1Database;
		SYNC_EMAIL_OUTBOX: Queue;
		SYNC_JOBS: Queue;
		APP_BASE_URL: "http://localhost:8787";
		ACCESS_TOKEN_TTL_SECONDS: "900";
		MAGIC_LINK_TTL_SECONDS: "900";
		REFRESH_TOKEN_TTL_SECONDS: "2592000";
		MOQ_ORIGIN: "https://moq.example.invalid";
		SYNC_SIGNING_KEY: "change-me-in-production";
		VAULT_AUTHORITY: DurableObjectNamespace<import("./src/index").VaultAuthority>;
		ROOM_AUTHORITY: DurableObjectNamespace<import("./src/index").RoomAuthority>;
	}
}
